        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset(
                "assets/images/nestle ghee.webp",
                fit: BoxFit.cover,
              ),
            ),
            SizedBox(
            ...
            Padding(
              ...
              child: Container(
                child: Uihelper.Customtext(
                    "Nestle Ghee", 26, FontWeight.bold, Colors.green),
              ),
            ),
            SizedBox(
              height: 10,
            ...
            Padding(
              ...
              child: Container(
                child: Uihelper.Customtext(
                    "Nestle Ghee is the most hygienic liquid milk available in the market. It is pasteurized in state-of-the-art processing plants and pouch-packed to make it conveniently available to consumers.",
                    20,
                    FontWeight.normal,
                    Colors.black),
              ),
