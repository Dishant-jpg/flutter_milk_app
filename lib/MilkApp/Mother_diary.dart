...
class Motherdiary extends StatefulWidget {
  const Motherdiary({super.key});

  @override
  State<Motherdiary> createState() => _MotherdiaryState();
}

class _MotherdiaryState extends State<Motherdiary> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Mother Diary Milk"),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Container(
                child: Uihelper.Customtext(
                    "Mother Diary Milk", 26, FontWeight.bold, Colors.green),
              ),
            ),
            SizedBox(
              height: 10,
            ...
            Padding(
              ...
              child: Container(
                child: Uihelper.Customtext(
                    "Mother Diary Milk is the most hygienic liquid milk available in the market. It is pasteurized in state-of-the-art processing plants and pouch-packed to make it conveniently available to consumers.",
                    20,
                    FontWeight.normal,
                    Colors.black),
              ),
