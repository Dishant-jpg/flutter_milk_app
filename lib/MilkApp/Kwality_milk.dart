...
class KwalityMilk extends StatefulWidget {
  const KwalityMilk({super.key});

  @override
  State<KwalityMilk> createState() => _KwalityMilkState();
}

class _KwalityMilkState extends State<KwalityMilk> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Kwality Milk "),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Container(
                child: Uihelper.Customtext(
                    "Kwality Milk", 26, FontWeight.bold, Colors.green),
              ),
            ),
            SizedBox(
              height: 10,
            ...
            Padding(
              ...
              child: Container(
                child: Uihelper.Customtext(
                    "Kwality Milk is the most hygienic liquid milk available in the market. It is pasteurized in state-of-the-art processing plants and pouch-packed to make it conveniently available to consumers.",
                    20,
                    FontWeight.normal,
                    Colors.black),
              ),
